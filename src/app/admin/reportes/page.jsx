    ...
    return (
        <main className="min-h-screen bg-[#F7F8FF] px-8 py-8">
            ...
            <div className="mb-8">
                ...
                <p className="text-sm text-[#443CA3]/50 mt-1">Resumen de tu portafolio de cobranza</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-6">
                ...
                <div className="md:col-span-2 bg-white border border-[#443CA3]/10 rounded-2xl p-6 hover:shadow-md transition-all duration-300">
                    <h2 className="font-semibold text-[#443CA3] mb-6">Distribución por Estado</h2>
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={barData} barSize={40}>
                            <CartesianGrid strokeDasharray="3 3" stroke="#443CA310" vertical={false} />
                            <XAxis
                                dataKey="status"
                                tick={{ fontSize: 11, fill: '#443CA3', opacity: 0.5 }}
                                axisLine={false}
                                tickLine={false}
                            />
                            <YAxis
                ...
                <div className="bg-white border border-[#443CA3]/10 rounded-2xl p-6 hover:shadow-md transition-all duration-300">
                    <h2 className="font-semibold text-[#443CA3] mb-6">Métricas del Portafolio</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                {/* Pie Chart */}
                <div className="bg-white border border-[#443CA3]/10 rounded-2xl p-6 hover:shadow-md transition-all duration-300">
                    <h2 className="font-semibold text-[#443CA3] mb-6">Deudores por Estado</h2>
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div className="bg-white border border-[#443CA3]/10 rounded-2xl p-6 hover:shadow-md transition-all duration-300">
                        ...
                        <p className="text-xs text-[#443CA3]/40 mt-2">Últimos 7 días: <span className="font-bold text-[#EF4444]">{data.calls.last7Days}</span></p>
                    </div>
                ...
                <div className="bg-white border border-[#443CA3]/10 rounded-2xl p-6 hover:shadow-md transition-all duration-300">
                    <h2 className="font-semibold text-[#443CA3] mb-6">Detalle por Estado</h2>
